...
//测试向服务器返回消息
	...
	[Message(HotfixOpcode.C2G_MyMessage)]
	public partial class C2G_MyMessage : IRequest {}

	[Message(HotfixOpcode.G2C_MyMessage)]
	public partial class G2C_MyMessage : IResponse {}
...
namespace ETModel
{
	public static partial class HotfixOpcode
	{
		 ...
		 public const ushort C2G_MyMessage = 10003;
