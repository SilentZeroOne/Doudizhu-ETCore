...
namespace ETModel {
  ...
  public partial class C2G_MyMessage : pb::IMessage {
    private static readonly pb::MessageParser<C2G_MyMessage> _parser = new pb::MessageParser<C2G_MyMessage>(() => (C2G_MyMessage)MessagePool.Instance.Fetch(typeof(C2G_MyMessage)));
    public static pb::MessageParser<C2G_MyMessage> Parser { get { return _parser; } }
    ...
    private string myInfo_ = "";
    public string MyInfo {
      get { return myInfo_; }
      set {
        myInfo_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public int CalculateSize() {
      ...
      if (MyInfo.Length != 0) {
        size += 2 + pb::CodedOutputStream.ComputeStringSize(MyInfo);
      }
      return size;
    }
  ...
  public partial class G2C_MyMessage : pb::IMessage {
    private static readonly pb::MessageParser<G2C_MyMessage> _parser = new pb::MessageParser<G2C_MyMessage>(() => (G2C_MyMessage)MessagePool.Instance.Fetch(typeof(G2C_MyMessage)));
    public static pb::MessageParser<G2C_MyMessage> Parser { get { return _parser; } }
